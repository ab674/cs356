...
class Router3 {
    ...
    Router3 (int routernumber, int interfacenumber) {
    ...
    void bellmanford (Router3 graph, int source) throws Exception {
    ...
    void printtable (int distancetable[], int routers) throws IOException {
        ...
        ServerSocket serversocket = new ServerSocket(21213);
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        int routernumber = 4;
        int interfacenumber = 5;
        Router3 distancetable = new Router3(routernumber, interfacenumber);
        ...
        distancetable.links[4].source = 2;
        distancetable.links[4].destination = 3;
        distancetable.links[4].cost = 2;
