...
class Router2 {
    ...
    Router2 (int routernumber, int interfacenumber) {
    ...
    void bellmanford (Router2 graph, int source) throws Exception {
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        Router2 distancetable = new Router2(routernumber, interfacenumber);
